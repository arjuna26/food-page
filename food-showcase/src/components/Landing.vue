<template>
    <div class="relative w-full h-[110vh] text-white overflow-hidden bg-darker">
        <div class="absolute z-10 w-full mx-auto py-30 px-0 grid grid-cols-12 bg-darker">
            <div class="absolute opacity-50 right-24 flex flex-row gap-10">
                <a href="https://instagram.com/your-account"><svg fill="#FFD700" height="200px" width="200px" class="cursor-pointer w-12" 
